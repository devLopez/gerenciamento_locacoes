		...
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box">
					...
					<br />
					<p class="lead">
						A página ou recurso não foi encontrado, entre em contato com o
						suporte ou tente novamente. Use o botão <b>voltar</b> do navegador
						para voltar para a página onde você estava.
					</p>
